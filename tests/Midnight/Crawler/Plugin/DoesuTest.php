...
class DoesuTest extends PHPUnit_Framework_TestCase
{
    ...
    public function 動画へのリンクを取得する ()
    {
        ...
        $this->assertEquals('http://flashservice.xvideos.com/embedframe/7395344', $movies_url[0]);
        $this->assertEquals('http://flashservice.xvideos.com/embedframe/7395350', $movies_url[1]);
        $this->assertEquals('http://flashservice.xvideos.com/embedframe/7395352', $movies_url[2]);
        $this->assertEquals('http://flashservice.xvideos.com/embedframe/7395354', $movies_url[3]);
    }
}
