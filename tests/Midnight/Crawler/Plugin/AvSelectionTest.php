...
class AvSelectionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function 動画へのリンクを取得する ()
    {
        ...
        $this->assertEquals('http://flashservice.xvideos.com/embedframe/7994012', $movies_url[0]);
        $this->assertEquals('http://flashservice.xvideos.com/embedframe/7994057', $movies_url[1]);
    }
}
