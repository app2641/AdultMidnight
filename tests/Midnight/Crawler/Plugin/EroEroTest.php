...
class EroEroTest extends PHPUnit_Framework_TestCase
{
    ...
    public function エントリのタイトルを取得出来なかった場合 ()
    {
        ...
        $html = $this->plugin->fetchHtml($this->test_data->getHtmlPaths()[7]);
     ...
     * @group eroero-not-get-eyecatch-img-el
     * @group eroero
     */
    ...
    public function src属性が見つからなかった場合 ()
    {
        ...
        $html = $this->plugin->fetchHtml($this->test_data->getHtmlPaths()[8]);
        $this->plugin->getEyeCatchUrl($html);
    }
