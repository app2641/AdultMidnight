...
class MuryoEro extends AbstractPlugin implements PluginInterface
{
     ...
     * @var string
     **/
    protected $rss_url = 'http://muryouerodouga.net/feed';
    ...
    {
        $query = 'div#content div.cnt-video div.info h2';
    ...
    {
        $query = 'div#content div.cnt-video p.thumb-video img';
    ...
    {
        $query = 'div#content div.cnt-video div.player iframe';
